    ...
    return (
        <section className="container mx-auto px-4 py-10 sm:py-12">
            <div className="flex items-center justify-between mb-6 sm:mb-8">
                <h2 className="text-2xl sm:text-3xl font-black text-white flex items-center gap-2 sm:gap-3 uppercase italic tracking-tighter">
                    <Trophy className="w-6 h-6 sm:w-8 sm:h-8 text-yellow-500" />
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-600">{t('league.title')}</span>
                </h2>
            </div>
                ...
                <Table>
                    <TableHeader className="bg-white/5">
                        <TableRow className="border-white/10 hover:bg-transparent">
                            <TableHead className="w-[40px] sm:w-[60px] text-center text-gray-400 font-bold text-xs sm:text-sm">#</TableHead>
                            <TableHead className="text-gray-400 font-bold text-xs sm:text-sm min-w-[120px]">{t('league.table.club')}</TableHead>
                            <TableHead className="text-center text-gray-400 font-bold hidden sm:table-cell text-xs sm:text-sm">{t('league.table.played')}</TableHead>
                            <TableHead className="text-center text-gray-400 font-bold hidden md:table-cell text-xs sm:text-sm">{t('league.table.won')}</TableHead>
                            <TableHead className="text-center text-gray-400 font-bold hidden md:table-cell text-xs sm:text-sm">{t('league.table.drawn')}</TableHead>
                            <TableHead className="text-center text-gray-400 font-bold hidden md:table-cell text-xs sm:text-sm">{t('league.table.lost')}</TableHead>
                            <TableHead className="text-center text-white font-black text-sm sm:text-lg">{t('league.table.points')}</TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
                            ...
                            {visibleTeams.map((team) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell className="text-center text-gray-400 font-mono hidden sm:table-cell text-xs sm:text-sm">{team.played}</TableCell>
                                        <TableCell className="text-center text-gray-400 font-mono hidden md:table-cell text-xs sm:text-sm">{team.won}</TableCell>
                                        <TableCell className="text-center text-gray-400 font-mono hidden md:table-cell text-xs sm:text-sm">{team.drawn}</TableCell>
                                        <TableCell className="text-center text-gray-400 font-mono hidden md:table-cell text-xs sm:text-sm">{team.lost}</TableCell>
                                        <TableCell className="text-center font-black text-base sm:text-xl text-white">{team.points}</TableCell>
                                    </motion.tr>
                                );
                            })}
                        </AnimatePresence>
