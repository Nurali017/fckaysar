...
const stories: Story[] = [
    ...
    },
    {
        ...
        image: "https://images.unsplash.com/photo-1516731238428-0017d0066226?q=80&w=800&auto=format&fit=crop",
        category: "Interview"
    },
    {
        id: 5,
    ...
    return (
        ...
        >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-3">
                <div className={`w-8 h-8 rounded-full border-2 ${story.isLive ? 'border-red-500 p-0.5' : 'border-white mb-2'}`}>
                    <img
                        src={story.image}
