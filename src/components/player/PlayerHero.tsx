...
export const PlayerHero = () => {
  ...
  return (
    <div className="relative min-h-[400px] md:min-h-[500px] h-auto overflow-hidden bg-gradient-to-br from-black via-red-950/30 to-black py-12 md:py-0">
      {/* Background Pattern */}
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center w-full">
          ...
          <div className="space-y-6 text-white order-1 md:order-2 text-center md:text-left">
            <div className="space-y-2">
              <div className="text-4xl sm:text-6xl md:text-9xl font-black text-red-600 opacity-20">
                10
              </div>
              <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold -mt-8 sm:-mt-12 md:-mt-24 relative z-10">
                Думан
                <br />
                Нәрзілдаев
              </h1>
